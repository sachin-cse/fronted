    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto text-center">
                <p class="text">Bhakti music is a genre of devotional music that is often associated with the practice of Bhakti yoga, a spiritual path emphasizing devotion and love for a personal deity, often in the context of Hinduism. In the context of ISKCON (International Society for Krishna Consciousness), Bhakti music is deeply connected with the teachings of Srila Prabhupada, the founder of ISKCON, and it typically revolves around the glorification of Lord Krishna.
                
                <p class="text">Bhakti music typically features lyrics that express deep devotion, love, and surrender to the divine. The lyrics often praise the qualities and pastimes of the chosen deity, such as Lord Krishna.</p>
                </p>
                <div class="mx-auto">
